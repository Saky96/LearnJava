...
class MapFiltrationDemo {
    ...
    public static void main(String[] args) {
        ...
        List<FantasyBook> fantasyBooksList = new ArrayList<>();

        Set<Map.Entry<Book, Author>> bookAuthorEntries = bookAuthorMap.entrySet();
        Iterator<Map.Entry<Book, Author>> bookAuthorEntryIterator = bookAuthorEntries.iterator();
        while(bookAuthorEntryIterator.hasNext()) {
            Map.Entry<Book, Author> bookAuthorEntry = bookAuthorEntryIterator.next();
